...
void minHeapify(struct MinHeap *minHeap, int idx) {
    ...
    int smallest = idx;
    int left = 2 * idx + 1; // Index of the left child of idx
    int right = 2 * idx + 2; // Index of the right child of idx
    // Index of the parent of idx: (idx + 1)/2 - 1
 ...
 * 2*(n – 1) times. extractMin() takes O(logn) time as it calles minHeapify(). So, overall complexity is O(nlogn). */
